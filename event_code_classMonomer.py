...
Path_ToConfiguration = Conf_output_dir+'/FinaulMonomerConf.p'
if os.path.isfile( Path_ToConfiguration ):
    ...
    #define parameters
    NumberOfMonomers = 1000
    L_xMin, L_xMax = 0, 3000
    L_yMin, L_yMax = 0, 1500
...
Delay_in_ms = 5 #dely between images/frames for plt.show()
